...
//    }
//
//    public boolean contains1(CharSequence s) {
//        return (s instanceof String)
//                ? indexOf((String) s) >= 0 :
//                indexOf(value, 0, value.length, s, 0, s.length(), 0) >= 0;
//    }
//
//    public boolean contains2(CharSequence s) {
//        return (s instanceof String
//                ? indexOf((String) s)
//                : indexOf(value, 0, value.length, s, 0, s.length(), 0))
//                >= 0;
//    }
//
//    public boolean contains3(CharSequence s) {
//        int index = (s instanceof String)
//                ? indexOf((String) s)
//                : indexOf(value, 0, value.length, s, 0, s.length(), 0);
//
//        return index >= 0;
